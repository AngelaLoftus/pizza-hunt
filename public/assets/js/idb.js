...
request.oneupgradeneeded = function(event) {
    ...
    //ccreate an object sore (table) called `new_pizza`, set it to have an aut incrementing primary key of sorts
...
//this function will be executed if we attempt to submit a new pizza and there's no interenet connection
